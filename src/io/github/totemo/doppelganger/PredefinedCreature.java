...
public enum PredefinedCreature implements IPredefinedCreature
{
  ...
  ZombieButcher(new PredefinedZombie(false, Profession.BUTCHER)),
  BabyZombieButcher(new PredefinedZombie(true, Profession.BUTCHER)),
  Farmer(new PredefinedVillager(false, Profession.FARMER)),
  BabyFarmer(new PredefinedVillager(true, Profession.FARMER)),
  ZombieFarmer(new PredefinedZombie(false, Profession.FARMER)),
  BabyZombieFarmer(new PredefinedZombie(true, Profession.FARMER)),
  ...
  ZombieLibrarian(new PredefinedZombie(false, Profession.LIBRARIAN)),
  BabyZombieLibrarian(new PredefinedZombie(true, Profession.LIBRARIAN)),
  Priest(new PredefinedVillager(false, Profession.PRIEST)),
  ...
  // --------------------------------------------------------------------------
  /**
   * PredefinedCreature implementation delegate for villagers with specified age
  ...
  static final class PredefinedVillager implements IPredefinedCreature
  {
     ...
     * Constructor.
     *
     * @param baby if true, the villager is a baby; otherwise it is an adult.
  ...
  static final class PredefinedZombie implements IPredefinedCreature
  {
     ...
     * Constructor.
     *
     * @param baby if true, the zombie villager is a baby; otherwise it is an
     *          adult.
  ...
  /**
   * PredefinedCreature enums delegate to this instance, set by the constructor.
   */
