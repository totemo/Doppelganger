...
public class CommandController implements CommandExecutor {
     ...
     * 
     * @param plugin The plugin whose commands will be considered for
     *        registration
    ...
    /**
     * An annotation interface that may be attached to a method to designate it
     * as a command handler. When registering a handler with this class, only
     * methods marked with this annotation will be considered for command
     * registration.
     * 
     * @author AmoebaMan
     */
    ...
    /**
     * An annotation interface that may be attached to a method to designate it
     * as a subcommand handler. When registering a handler with this class, only
     ...
     * assigned to the command or subcommand Beyond checking permissions,
     * checking player/console sending, and invoking handlers and methods, this
     * method does not actually act on the commands
     */
    @Override
